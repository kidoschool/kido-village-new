            ...
            <section className="banner-parent py-5" style={{backgroundColor : "#fff"}}>
                <div className="container">
                        ...
                        <div className="container">
                            ...
                            <h1 className="banner-head pb-2">What is Kido Village?</h1>
                                <div className="col-lg-10">
                                    ...
                                    <p>If you are a parent looking for education and care for your child, <Link to="/Parent" className="hiper-link"><span>find a pod near you,</span> </Link>and you will be assured of a trained and certified provider in your community at affordable prices. Teaching will be in small groups (maximum of eight children) to ensure customization and attention for each child.</p>
                                    <p>If you are interested in teaching, you can <Link to="/pods" className="hiper-link"><span>set up a micro-preschool</span></Link> (we call it a Kïdo Village Pod) at home for your children, or children in the neighborhood. For as little as ₹1500/month, we'll provide the training, curriculum, support, quality control and everything you'll need to be a successful teacher or Pod owner.</p>
                    ...
                    <section className="video-card py-5">
                        <div className="container">
                        <h1 className="banner-head text-center pb-3">Hear from our Kido Village Pod teachers</h1>
                            <div className="row justify-content-center">
