                ...
                <div className="row justify-content-center">
                    ...
                    <h1 className="banner-head">Benefits of Kido Village </h1>
                        <ul className="k-advantage pt-4">
                            ...
                            <li><strong className="text-dark">Marketing</strong> - You will have all the marketing support you'll need. You will have a page on the website to help parents schedule tours directly with you. Marketing materials will be provided to help you market around you neighbourhood, reach out to more people in your network.</li>
