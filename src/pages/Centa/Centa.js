            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-10">
                        ...
                        <p className="centa-text pt-3">We’re proud to partner with <a target="_blank" rel="noopener noreferrer" href="https://centa.org/" className="centa-link" >CENTA</a>, the Centre for Teacher Accreditation in India to deliver training and accreditation for all of our Pod Partners. Through our partnership, we offer the following certified trainings for all Pod Partners:</p>
                        ...
                        <p className="centa-text">Please <Link to="/pods" className="centa-link">click here</Link> for more details, and to register for the training.</p>
                    </div>
                </div>
            </div>
        </section>
